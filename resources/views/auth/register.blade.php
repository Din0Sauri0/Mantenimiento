    ...
    <div class='bg-white w-full rounded-xl drop-shadow-md p-[5%]  overflow-auto'>
        ...
        <form action="#" method="post" class='flex flex-col p-2 gap-3 mt-3'>
            ...
            <div class='relative flex items-center'>
                ...
                <input class='border-none ring-2 ring-orange-100 hover:ring-orange-400 focus:ring-2 focus:ring-orange-400 h-9 w-full pr-3 pl-10 bg-gray-100 rounded-xl' type="text" name="nombre_empresa" id="nombre_empresa">
            </div>
            ...
            <div class='relative flex items-center'>
                ...
                <input class='border-none ring-2 ring-orange-100 hover:ring-orange-400 focus:ring-2 focus:ring-orange-400 h-9 w-full pr-3 pl-10 bg-gray-100 rounded-xl' type="text" name="rut_empresa" id="rut_empresa">
            </div>
            ...
            <div class='relative flex items-center'>
                ...
                <input class='border-none ring-2 ring-orange-100 hover:ring-orange-400 focus:ring-2 focus:ring-orange-400 h-9 w-full pr-3 pl-10 bg-gray-100 rounded-xl' type="text" name="direccion" id="direccion">
            </div>
            ...
            <div class='relative flex items-center'>
                ...
                <input class='border-none ring-2 ring-orange-100 focus:ring-2 hover:ring-orange-400 focus:ring-orange-400 h-9 w-full pr-3 pl-10 bg-gray-100 rounded-xl' type="password" name="re-password" id="re-password">
            </div>
