<div>
    <form wire:submit.prevent="save" method="POST" class='flex flex-col p-2 gap-3 mt-3'>
        @csrf
        ...
        <div class="flex flex-col">
            ...
            <div class='relative flex items-center'>
                ...
                <input class='border-none ring-2 ring-orange-100 hover:ring-orange-400 focus:ring-2 focus:ring-orange-400 h-9 w-full pr-3 pl-10 bg-gray-100 rounded-xl' type="text" name="name" id="name" wire:model="name">
            </div>
            @error('name')
            <div class="bg-red-100 mt-1 border-l-4 border-red-500 p-1">
                <span class="text-red-500">{{ $message }}</span>
        ...
        <div class="flex flex-col">
            ...
            <div class='relative flex items-center'>
                ...
                <input class='border-none ring-2 ring-orange-100 hover:ring-orange-400 focus:ring-2 focus:ring-orange-400 h-9 w-full pr-3 pl-10 bg-gray-100 rounded-xl' type="text" name="address" id="address" wire:model="address">
            </div>
            @error('address')
            <div class="bg-red-100 mt-1 border-l-4 border-red-500 p-1">
                <span class="text-red-500">{{ $message }}</span>
